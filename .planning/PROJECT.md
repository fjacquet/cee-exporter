...
**Shipped v3.0 on 2026-03-04.** 4,623 Go LOC across 9 packages. 86 automated tests.

Tech stack: Go 1.24+, `net/http`, `encoding/xml`, `log/slog`, `golang.org/x/sys/windows`, `golang.org/x/crypto/acme/autocert`, `github.com/BurntSushi/toml`, `github.com/prometheus/client_golang`, `github.com/kardianos/service`, `github.com/crewjam/rfc5424`, `github.com/elastic/go-lumber`.
...
- `buildWriter` has no `case "win32":` arm (minor — Win32 only reachable via `type="evtx"` on Windows)
