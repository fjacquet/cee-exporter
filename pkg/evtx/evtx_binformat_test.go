// evtx_binformat_test.go — unit tests for EVTX binary format helpers.
//
// No build tag: tests run on Linux CI without cross-compilation.
...
func TestPatchChunkCRC(t *testing.T) {
	...
	// chunk[120:128] was zeroed inside patchChunkCRC; we read chunk[128:512]
	// directly (unmodified by patchChunkCRC).
